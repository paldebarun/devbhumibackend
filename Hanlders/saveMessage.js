...
exports.saveMessage = async (req, res) => {
    try {
        ...
        let info = await transporter.sendMail({
         ...
         <p>Thank you for reaching out to AyurWell with your inquiry. We appreciate your interest in our Ayurvedic solutions for well-being.</p>
         ...
         <p>Thank you once again for considering AyurWell as your Ayurvedic partner on your journey to wellness.</p>
         <p>Best regards,</p>
         <p style="font-weight: bold;">AyurWell Team,<br>AyurWell Enterprises</p>
     </div>
